...
class ConfigViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        datasource.append(ConfigItem(title: "取消按钮边框颜色", value: "\(CKAlertViewConfiguration.shared.cancelBorder.color.toHexString())",valueChanged: {(str :String) in CKAlertViewConfiguration.shared.cancelBorder.color = HexColor(str.toHex(),1)}))
        ...
        datasource.append(ConfigItem(title: "其他按钮边框颜色", value: "\(CKAlertViewConfiguration.shared.cancelBorder.color.toHexString())",valueChanged: {(str :String) in CKAlertViewConfiguration.shared.cancelBorder.color = HexColor(str.toHex(),1)}))
