...
Pod::Spec.new do |s|
  s.name             = 'CKAlertView'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CKAlertView.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/CKAlertView'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'kaich' => 'chengkai1853@163.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/CKAlertView.git', :tag => s.version.to_s }
